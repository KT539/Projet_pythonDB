...
def makeReservation_window(win):
    ...
    # title label
    label_title = tk.Label(inner_frame, text="New reservation", width=20, height=1, font=("Arial", 20, "bold"), fg="#000000")
    label_title.grid(row=0, column=0, padx=10, pady=(10, 60), sticky="n")

    # instructions label
    label_instruction = tk.Label(inner_frame, text="Please enter the name of \nthe concert you wish to attend", width=25, height=2, font=("Arial", 15), fg="#000000")
    label_instruction.grid(row=1, column=0, padx=10, pady=(60, 20), sticky="n")

    # concert name entry
    cname_label = tk.Label(inner_frame, text="Concert name", width=20, height=1, font=("Arial", 15), bg="#FFFFFF", fg="#000000")
    ...
    btn_confirm = tk.Button(inner_frame, text="Confirm my reservation", width=20, height=1, font=("Arial", 15), bg="#FFFFFF", fg="#000000")
