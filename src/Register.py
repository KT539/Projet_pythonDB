...
def register_window(win):
    ...
    # firstname entry
    fname_label = tk.Label(inner_frame, text="Enter your first name *", width=20, height=1, font=("Arial", 12), bg="#FFFFFF", fg="#000000")
    ...
    # lastname entry
    lname_label = tk.Label(inner_frame, text="Enter your last name *", width=20, height=1, font=("Arial", 12), bg="#FFFFFF", fg="#000000")
    ...
    # birthdate entry
    bdate_label = tk.Label(inner_frame, text="Enter your birthdate (YYYY-MM-DD)", width=20, height=1, font=("Arial", 12), bg="#FFFFFF", fg="#000000")
    ...
    # password entry
    pword_label = tk.Label(inner_frame, text="Enter your password *", width=20, height=1, font=("Arial", 12), bg="#FFFFFF", fg="#000000")
